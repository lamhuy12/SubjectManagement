...
public class DeleteLessonServlet extends HttpServlet {
    ...
    private final String ERROR_PAGE = "errorDeleteLesson.html";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String lessonID = request.getParameter("pkDeleteLesson");
        String subjectID = request.getParameter("subIDDelete");
        String urlRewriting = ERROR_PAGE;
        try {

            LessonDAO dao = new LessonDAO();
            boolean result = dao.deleteLesson(lessonID);
            ...
            if (result) {
                ...
                boolean history = historyDAO.history("DeleteLesson", new Date());
            }
        } finally {
