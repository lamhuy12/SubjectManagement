...
public class UpdateAccountServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean result = dao.updateAccount(username, fullname, role);
            ...
            if (result) {
                ...
                boolean history = historyDAO.history("UpdateAccount", new Date());
            }
            ...
            log("UpdateServlet_Exception " + e.getMessage());
        } finally {
