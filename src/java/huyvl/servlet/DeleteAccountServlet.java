...
public class DeleteAccountServlet extends HttpServlet {
    ...
    private final String ERROR_PAGE = "errorDeleteAccount.html";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean history = historyDAO.history("DeleteAccount", new Date());
            } // end if delete ok 
            ...
            log("DeleteAccountServlet_Exception: " + ex.getMessage());
        } finally {
