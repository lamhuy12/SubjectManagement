...
public class UpdateQuestionServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = "subject.jsp";
        String question = request.getParameter("txtQuestionID");
        try {
            QuestionDAO dao = new QuestionDAO();
            boolean result = dao.updateQuestion(question);
            
            if (result) {
                url = "subject.jsp";
                HistoryDAO historyDAO = new HistoryDAO();
                boolean history = historyDAO.history("UpdateQuestion", new Date());
            }
            ...
            log("UpdateQuestionServlet_Exception: " + ex.getMessage());
        } finally {
