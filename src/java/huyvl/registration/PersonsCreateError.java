 ...
 * @author HUYVU
 */
public class PersonsCreateError implements Serializable {
    ...
    public PersonsCreateError() {
    }

    public PersonsCreateError(String usernameLengthErr, String passwordLengthErr, 
            String fullnameLengthErr, String confirmNotMatched, String usernameIsExisted) {
